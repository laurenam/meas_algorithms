...
public:
     ...
     *
     *  This overload passes a user-defined center to the algorithms.  If refineCenter==true and
     *  setCentroider has been called, that algorithm will be used to refine the centroid.
     */
     ...
     *  @brief Apply the registered algorithms to the given source.
     *
     *  This overload uses the peak position as the center for the algorithms.
